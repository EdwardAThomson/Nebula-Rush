...
const TRACKS = [
    ...
    {
        id: 'track_9', name: 'Dune Sprint',
        points: [
            [0, 0, 0], [600, 2, 60], [1200, 5, 120], [1620, 7, 0], [1770, 9, -390],
            [1620, 7, -840], [1230, 5, -1380], [840, 8, -1860], [540, 10, -2250], [180, 11, -2490],
            [-270, 9, -2340], [-540, 6, -1920], [-570, 4, -1380], [-450, 3, -840], [-270, 1, -360],
            [-150, 0, -60],
        ],
    },

    {
        id: 'track_10', name: 'Solstice Classic',
                                                points: [
            [0, 0, 0],
            [20, 9, -350],
            [20, 11, -720],
...
const WIDTH: Record<string, { t: number; half: number }[]> = {
    ...
    track_9: [
        { t: 0.00, half: 82 }, { t: 0.25, half: 74 }, { t: 0.40, half: 84 },
        { t: 0.56, half: 72 }, { t: 0.72, half: 84 }, { t: 0.90, half: 78 },
    ],

    track_10: [
        { t: 0.00, half: 78 }, { t: 0.5, half: 82 },
    ],
};
